<?php
	...
	$year = $_GET['year'];
	$sql = "SELECT title_y, poet, img, poem FROM poem WHERE YEAR(date)='" . $year . "' AND public IS TRUE AND genre='story' ORDER BY title_y";
    ...
    <body>
        ...
        <div class="frame">
            ...
            <ul class="link_list eng" id="work_list_eng">
            	<?php
            		$sql = "SELECT title_e, poet, poem, img FROM poem WHERE YEAR(date)='" . $year . "' AND public IS TRUE AND genre='story' ORDER BY title_e;";
