...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="http://לידער.us.org/style.css">
    ...
    <body>
		...
		<div class="instructions">
			...
			<br>Just want to suggest a story/writer, just email.
			<br>Our email: balebos@לידער.us.org
</div>
	    <br>
            <fieldset>
                <legend>The Story, in English</legend>
                Story Title*:<br>
                <input type="text" name="title_eng" placeholder="Title" data-tippy="Enter the English translation of the title" required>
                <br>
                Writer*:<br>
                <select class="name_e" type="text" data-tippy="Check for various spellings of the writer in this list. If they are not there choose new writer." name="poet_eng">
                    <option value="new" selected>New Writer:</option>
                    <?php
                ...
                <input type="text" name="new_poet_eng" class="poet" placeholder="New Writer">
                <br>
                Translator:<br>
                <input type="text" name="translator" placeholder="Translator">
                <br>
                The Story:<br>
                <textarea name="poem_eng" rows="10" cols="100" placeholder="The Story (its translation)."></textarea>
                <br>
                Publication Date: <br>
                Month:
                <select name="month">
                ...
                Year*:
                <input type="number" name="year" placeholder="1900" data-tippy="If a date is specified on the story itself, enter this, otherwise use the publication date of the source" required>
            </fieldset>
            <br>
            <fieldset>
                <legend>The Story, in Yiddish</legend>
                Story Title*:<br>
                <input type="text" name="title_yid" placeholder="טיטל" dir="rtl" required>
                <br>
                Writer*:<br>
                <select class="name_y" type="text" name="poet_yid" data-tippy="Check for various spellings of the writer in this list. If they are not there choose new writer." dir="rtl">
                    <option value="new" dir="rtl" selected>נײַער שרײַבער</option>
                    <?php
                    $results = $mysql->query($sql);
                    while($result = $results->fetch_assoc()) {
                ...
                <input type="text" name="new_poet_yid" class="poet" placeholder="נײַער שרײַבער">
                <br>
                Source*:<br>
                ...
                <br>
                The Story*:<br>
                <textarea name="poem_yid" rows="10" cols="100" dir="rtl" placeholder="די דערצײלונג!" data-tippy="Try not to 'standardize' the Yiddish, but transcribe it as it is in the source." required></textarea>
            </fieldset>
            <br>
            <fieldset>
                <legend>The Recording</legend>
                The Story Reading:<br>
            ...
            <br>
            <fieldset>
                <legend>Writer Blurb</legend>
                About the Writer:<br>
                <textarea name="bio" class="poet" rows="10" cols="100" placeholder="Write something interesting about the writer!" data-tippy="This should be an original short blurb and in English. Authorship is anonymous. It's great to reference things that are linked to in the resources section."></textarea><br>
                Birth Date: <br>
                Month:
            ...
            <fieldset>
                ...
                <textarea name="con" rows="10" cols="100" placeholder="Write some historical/social/literary background relevant to this story, writer, time, etc." data-tippy="This should be an original short blurb and in English. Authorship is anonymous. It can be anything from short analysis to historical context. It's great to reference things that are linked to in the resources section."></textarea><br>
                An Illuminating Image: <br>
                <input type="file" name="con_img" accept="image/*" data-tippy="A picture that may enrich, complicate, sully, or do nothing to one's understanding of the story.">
                <br>Photo Credit:<br>
