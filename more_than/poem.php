   ...
   <body>
	  ...
	  <div id="img_popup_cap"></div>
        ...
        <div class="poem_wrapper">
            <div class="reading">
	    	<?php echo (is_null($poem['reader']) ? '<img class="rec_img" src="https://לידער.us.org/aleph.jpeg">' : ('<audio controls><source src="readings/' . $poem['rec'] . '" type="audio/mpeg">Your browser does not support the audio element. </audio>')); ?>
