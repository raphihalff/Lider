<?php
	...
	$poet_check = "SELECT poem FROM poem WHERE poet='" . $poet . "' AND public IS TRUE AND genre='story'";
    ...
    <body>
        ...
        <div class="frame">
            ...
            <ul class="link_list yid default" id="work_list_yid" dir="rtl">
            	<?php
            		$sql = "SELECT title_y, poet, img, poem FROM poem WHERE poet='" . $poet . "' AND public IS TRUE AND genre='story' ORDER BY title_y";
            ...
            <ul class="link_list eng" id="work_list_eng">
            	<?php
            		$sql = "SELECT title_e, poet, poem, img FROM poem WHERE poet='" . $poet . "' AND public IS TRUE AND genre='story' ORDER BY title_e";
