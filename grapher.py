...
def make_collections():
  ...
  cursor = cnx.cursor()
  query = "SELECT poem.poem as poem, title_y, trans.title as title_e, poem.poet as poet, YEAR(date), text_y FROM poem LEFT JOIN trans on poem.poem=trans.poem WHERE genre='poem' AND public IS TRUE AND trans.lang='eng'"
